...
- **In Raumsuche einschließen (4)** Der Raum kann dann über die [Raumsuche](list) gefunden werden. Das eignet sich besonders für digitale Büros, aber auch über Vorlesungen die allen Mitgliedern der THM offen stehen sollen. Diese Option wird Ihnen nur angezeigt, wenn die Raumart dies unterstützt und Sie keinen Zugangscode haben.
