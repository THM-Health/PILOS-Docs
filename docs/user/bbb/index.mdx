...
:::tip Sichtbarkeit der Teilnehmerliste ändern

Standardmäßig sehen alle Teilnehmer die vollständige Teilnehmerliste. Über die Einschränkung der Teilnehmerrechte kann dies gepasst werden.
[Mehr erfahren](#teilnehmerrechte-einschränken)
...
:::info Bedeutung der Rollen

[Mehr erfahren](#rollen)
...
Diese Funktion kann nur von den Moderatoren verwendet werden

:::

Um die Anwesenheit zu protokollieren, kann jederzeit eine Liste mit den Namen der aktuell anwesenden Teilnehmer heruntergeladen werden.

![Anwesenheitsliste](./assets/save_user_list.png)

:::tip Anwesenheit während der gesamten Videokonferenz

Zur Protokollierung der Anwesenheit während der gesamten Videokonferenz kann die Protokollierung der Anwesenheit in PILOS aktiviert werden.
[Mehr erfahren](../room/settings.mdx#anwesenheit-der-teilnehmer-protokollieren-4)
:::
...
Um die Regeln wieder zu deaktivieren, öffnen Sie erneut das Dialogfenster und geben alle Funktionen frei.
...
![Einschränken](./assets/restrict.gif)

#### Ausnahme für einzelne Teilnehmer

Sie können auch einzelne Nutzer freischalten, damit die Einschränkungen für diese nicht gelten.

Klicken Sie dafür in der Teilnehmerliste auf den Namen des Teilnehmers und wählen "Freigeben" aus.

Damit die Einschränkungen für den Nutzer wieder gelten, klicken Sie erneut auf den Namen und wählen "Sperren" aus.

![Freigaben und Sperren](./assets/lock_unlock.gif)
...
Um Teilnehmer aus der Videokonferenz zu entfernen, klicken Sie in der Teilnehmerliste auf den Namen des Nutzers und wählen "Teilnehmer entfernen" aus.

In dem Dialogfenster können Sie den Nutzer für die restliche Videokonferenz sperren, sodass dieser nicht mehr teilnehmen kann.

:::warning Achtung
- Die Sperrung kann für die Dauer der Videokonferenz **nicht widerrufen** werden.
- Die Sperrung funktioniert nur für angemeldete Nutzer zuverlässig, Gäste können die Sperrung umgehen.
:::

![Nutzer entfernen](./assets/remove_user.gif)
...
Wählen Sie den Betritt mit einem Mikrofon, können Sie anschließend die Audioverbindung testen. Sollten Sie sich nicht verstehen, klicken Sie auf "Nein" und die Audiogeräte zu konfigurieren.
...
Moderatoren können einzelne Nutzer stummschalten.

Klicken Sie dafür in der Teilnehmerliste auf den Namen des Teilnehmers und wählen "Teilnehmer stummschalten" aus.

Die Nutzer können von dem Moderator nicht wieder freigeschaltet werden, dies muss durch den Nutzer selber erfolgen.
Die Stummschaltung wird nicht erzwungen, die Nutzer können sich jederzeit selber wieder freischalten.

:::tip Stummschaltung erzwingen

Damit sich die Teilnehmer nicht selber freischalten können, lässt sich die Mikrofonnutzung für alle Teilnehmer einschränken.
[Mehr zur Einschränkung von Teilnehmerrechten erfahren](#teilnehmerrechte-einschränken)

:::

![Andere Stummschalten](./assets/mute_user.png)


#### Alle Nutzer stummschalten
...
Alternativ zur Stummschaltung einzelner Teilnehmer, können Moderatoren auch alle Teilnehmer oder alle Teilnehmer mit Ausnahme des Präsentators stummschalten.

Klicken Sie dafür auf das Zahnrad-Symbol in der Teilnehmerliste und wählen "Alle Teilnehmer stummschalten" oder "Alle Teilnehmer außer den Präsentator stummschalten" aus.
...
![Alle Stummschalten](./assets/mute_all.gif)
...
Diese Funktion kann nur von dem Präsentator verwendet werden
